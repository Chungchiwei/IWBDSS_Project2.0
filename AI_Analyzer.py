...
class AIAnalyzer:
    ...
    def _build_user_prompt(
        ...
        duration_hrs = max( 0.0,(departure_time - berthing_time).total_seconds() / 3600.0)
...
@st.cache_resource
def get_cached_ai_analyzer(api_key: str = "") -> AIAnalyzer:
    """api_key 傳空字串時自動從 Secrets 讀取"""
    return AIAnalyzer(api_key=api_key or None)
